...
set "scriptLocation=C:\Scripts\Open_with_Code_wsl.vbs"
set "VscoIcon=C:\Users\Harman\AppData\Local\Programs\Microsoft VS Code\Code.exe"
set "registryKeyName=WSL VSCode"
set "ContextMenuCommandName=Open with Code (wsl)"
